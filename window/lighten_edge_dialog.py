...
class LightenEdgeDialog(wx.Dialog):
    ...
    def __init_widgets(self):
        ...
        stext_sz = wx.StaticText(panel, -1, "Alpha")
        sz_layout = wx.BoxSizer(wx.HORIZONTAL)
        self.slider_size = wx.Slider(panel, -1, minValue=0, maxValue=100, )
    ...
    def __on_btn_confirm_click(self, evt):
        ...
        self.function.lighten_edge(float(sz))
