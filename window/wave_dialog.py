...
class WaveDialog(wx.Dialog):
    ...
    def __init_widgets(self):
        ...
        stext_sz = wx.StaticText(panel, -1, "扭曲度")
        sz_layout = wx.BoxSizer(wx.HORIZONTAL)
        self.slider_size = wx.Slider(panel, -1, minValue=0, maxValue=50,)
